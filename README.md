...
## Hardware:
Оригинальное устройство собиралось автором на тестовой плате ***WEMOS-D1-MINI***. Текущая ветка устройства была переработана в аппаратной части и переведена на модуль ***ESP-WROOM-02U***. Была создана собственная версия печатной платы, с сохранением 
...
More information can be found at this link [Hardware.md](Hardware.md).
